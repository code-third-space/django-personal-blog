    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('test_score_of_general_ability', models.DecimalField(blank=True, decimal_places=1, max_digits=3, null=True, verbose_name='综合能力评测成绩')),
                ...
                ('second_score', models.DecimalField(blank=True, decimal_places=1, help_text='1-5分, 极优秀: >=4.5, 优秀: 4-4.4, 良好: 3.5-3.9, 一般: 3-3.4, 较差: <3分', max_digits=2, null=True, verbose_name='复试得分')),
                ...
                ('hr_score', models.CharField(blank=True, choices=[('S', 'S'), ('A', 'A'), ('B', 'B'), ('c', 'C')], help_text='1-5分, 极优秀: >=4.5, 优秀: 4-4.4, 良好: 3.5-3.9, 一般: 3-3.4, 较差: <3分', max_length=10, verbose_name='HR复试综合等级')),
                ...
                ('first_interviewer_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='first_interviewer_user', to=settings.AUTH_USER_MODEL, verbose_name='一轮面试官')),
                ...
                ('second_interviewer_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='second_interviewer_user', to=settings.AUTH_USER_MODEL, verbose_name='二轮面试官')),
            ],
            options={
                'verbose_name': '应聘者',
