...
class Candidate(models.Model):
    ...
    major = models.CharField(max_length=135, blank=True, null=True, verbose_name=u'专业')
    degree = models.CharField(max_length=135, choices=DEGREE_TYPE, blank=True, null=True, verbose_name=u'学历')

    #综合能力评测成绩，笔试评测成绩
    test_score_of_general_ability = models.DecimalField(decimal_places=1, null=True, 
                                                        max_digits=3, blank=True, verbose_name=u'综合能力评测成绩')
    ...
    first_interviewer_user = models.ForeignKey(User, related_name='first_interviewer_user', blank=True,
                                               null=True, on_delete=models.CASCADE, verbose_name=u"一轮面试官")
    first_remark = models.CharField(max_length=135, blank=True, verbose_name=u"初试备注")

    #第二轮面试记录
    second_score = models.DecimalField(decimal_places=1, null=True, max_digits=2, blank=True, verbose_name=u"复试得分",
                                       help_text=u'1-5分, 极优秀: >=4.5, 优秀: 4-4.4, 良好: 3.5-3.9, 一般: 3-3.4, 较差: <3分')
    ...
    second_interviewer_user = models.ForeignKey(User, related_name='second_interviewer_user', blank=True,
                                                null=True, on_delete=models.CASCADE, verbose_name=u"二轮面试官")
    ...
    hr_interviewer_user = models.ForeignKey(User, related_name='hr_interviewer_user', blank=True,
                                            null=True, on_delete=models.CASCADE, verbose_name=u"HR面试官")
