...
class Candidate(models.Model):
    ...
    hr_interviewer_user = models.ForeignKey(User, models.DO_NOTHING, related_name='candidate_hr_interviewer_user_set', blank=True, null=True)
    second_interviewer_user = models.ForeignKey(User, models.DO_NOTHING, related_name='candidate_second_interviewer_user_set', blank=True, null=True)
