...
#基础信息，第一轮面试，第二轮面试，HR面试记录--分组
    
    fieldsets = (
        (None, {'fields':("userid",("username","city",),
                          ("phone","email",),("apply_position","born_address",),
        ...
        ('第一轮面试记录', {'fields':(("first_score","first_learning_ability",),
                               ...
                               ("first_result","first_recommend_position",),
                               ("first_interviewer_user","first_remark",),
                               )}),
        ('第二轮专业复试记录', {'fields':(("second_score","second_learning_ability",),
        ...
        ('HR终面记录', {'fields':(("hr_score","hr_responsibility",),
