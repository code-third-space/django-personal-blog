    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('papre_score', models.DecimalField(blank=True, decimal_places=1, max_digits=3, null=True, verbose_name='笔试成绩')),
                ...
                ('first_interviewer', models.CharField(blank=True, max_length=135, verbose_name='面试官')),
                ('first_remark', models.CharField(blank=True, max_length=135, verbose_name='初试备注')),
                ('second_score', models.DecimalField(blank=True, decimal_places=1, max_digits=2, null=True, verbose_name='复试得分')),
                ...
                ('hr_ramark', models.CharField(blank=True, max_length=256, verbose_name='HR复试备注')),
